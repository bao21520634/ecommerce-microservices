...
import { NestedEnumCheckoutStatusWithAggregatesFilter } from './nested-enum-checkout-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumCheckoutStatusFilter } from './nested-enum-checkout-status-filter.input';

@InputType()
export class EnumCheckoutStatusWithAggregatesFilter {
