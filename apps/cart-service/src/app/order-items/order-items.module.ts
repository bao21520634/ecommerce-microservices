...
import { OrderItemCommandHandlers } from './commands';
import { OrderItemQueryHandlers } from './queries/handlers';
...
@Module({
    ...
    providers: [
        ...
        {
            provide: 'orderItem',
            useFactory: (prismaRepo: PrismaRepository) => prismaRepo.orderItem,
